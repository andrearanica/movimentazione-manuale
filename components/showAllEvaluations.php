<div id="table" class="card text-center my-2">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "
            <tr style='border: 1px solid black;'><td><img width='40' src='./pencil.jpg'></td><td>$id</td><td>$businessName</td><td>$date</td><td>$cost €</td><td>$realWeight kg</td><td>$maximumWeight kg</td><td>$IR</td><td><a style='color: black; text-decoration: underline;' href='./php/printPdf.php?id=$id'>PDF</a></td>$post</tr>
            ";
        }
    }
    echo '</table>';
