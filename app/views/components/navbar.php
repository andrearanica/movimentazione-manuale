<nav class='navbar navbar-expand-lg navbar-dark bg-dark'>
  <div class='container-fluid'>
    <a class='navbar-brand' href='dashboard'>Benvenuto, <?php echo $_SESSION['name_surname']; ?></a>
...
<?php require('../app/views/components/accountInfo.php'); ?>
<?php require('../app/views/components/helpModal.php');   ?>
